...
Feature: Synchronization Configuration
  ...
  Scenario: Successfully save synchronization configuration with default values and new synerise catalog
    ...
    And the ".page-body #card-config tr:nth-child(1) td:last-child" element should contain "1234"
    And the ".page-body #card-config tr:nth-child(2) td:last-child" element should contain catalog name
    And the ".page-body #card-config tr:nth-child(4) td:last-child" element should contain "Value"
  ...
  Scenario: Successfully save synchronization configuration with not default values and existing synerise catalog
    ...
    And I should see "Synchronization configuration has been successfully created."
    And the saved synchronization configuration should exist in repository
    And the ".page-body #card-config tr:nth-child(1) td:last-child" element should contain "123"
    And the ".page-body #card-config tr:nth-child(2) td:last-child" element should contain catalog name
    And the ".page-body #card-config tr:nth-child(3) td:last-child" element should contain "Description"
    And the ".page-body #card-config tr:nth-child(3) td:last-child" element should contain "Brand"
    And the ".page-body #card-config tr:nth-child(4) td:last-child" element should contain "Id"
