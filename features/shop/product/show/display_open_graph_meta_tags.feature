...
Feature: OpenGraph meta tags on product page
    ...
    Background:
        ...
        And this product has a text attribute "code" with value "symfony-t-shirt"
    ...
    Scenario: Viewing OpenGraph meta tags on a product page with regular price
        ...
        And I should see OpenGraph meta tag "title" with value "Symfony T-Shirt"
        And I should see OpenGraph meta tag "image"
        And I should see OpenGraph meta tag "price" with value "19.99"
        And I should see OpenGraph meta tag "retailer_part_no" with value "symfony-t-shirt"
