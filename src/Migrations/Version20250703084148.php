 ...
 */
final class Version20250703084148 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE synerise_synchronization ADD CONSTRAINT FK_A9B5B81A72F5A1AA FOREIGN KEY (channel_id) REFERENCES sylius_channel (id)');
        $this->addSql('ALTER TABLE synerise_synchronization_config ADD CONSTRAINT FK_F0CA4B8C72F5A1AA FOREIGN KEY (channel_id) REFERENCES sylius_channel (id)');
