 ...
 */
final class Version20250623111533 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE synerise_synchronization_product_attributes ADD CONSTRAINT FK_47DB1EFA15E7E326 FOREIGN KEY (synchronization_config_id) REFERENCES synerise_synchronization_config (id)
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE synerise_synchronization_product_attributes ADD CONSTRAINT FK_47DB1EFAB6E62EFA FOREIGN KEY (attribute_id) REFERENCES sylius_product_attribute (id)
        SQL);
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE synerise_synchronization_product_attributes DROP FOREIGN KEY FK_47DB1EFA15E7E326
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE synerise_synchronization_product_attributes DROP FOREIGN KEY FK_47DB1EFAB6E62EFA
        SQL);
        $this->addSql(<<<'SQL'
        ...
        SQL);
        $this->addSql(<<<'SQL'
            DROP TABLE synerise_synchronization_product_attributes
        SQL);
        $this->addSql(<<<'SQL'
